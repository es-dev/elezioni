...
{
    partial class ScrutinioCandidatoItem
	{
	        /// <summary>
		...
		private void InitializeComponent()
		{
            ...
            this.ItemClick += new Library.Template.MVVM.TemplateItem.ItemClickHandler(this.ScrutinioCandidatoItem_ItemClick);
