...
{
    public class ScrutinioListaViewModel : Library.Template.MVVM.TemplateViewModel<ScrutinioListaDto, ScrutinioListaItem>
    {

        public ScrutinioListaViewModel(ISpace space)
            : base(space) 
        {
            try
            {
        ...
        public override int GetCount()
        {
            ...
            {
                var wcf = new WcfService.Service();
                var count = wcf.CountScrutiniLista();
                return count;
            }
            catch (Exception ex)
            {
