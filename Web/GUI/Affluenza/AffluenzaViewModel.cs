...
{
    public class AffluenzaViewModel : Library.Template.MVVM.TemplateViewModel<AffluenzaDto, AffluenzaItem>
    {

        public AffluenzaViewModel(ISpace space)
            : base(space) 
        {
            try
            {
