...
{
    public class CollegioViewModel : Library.Template.MVVM.TemplateViewModel<CollegioDto, CollegioItem>
    {

        public CollegioViewModel(ISpace space)
            : base(space) 
        {
            try
            {
